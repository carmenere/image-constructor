...
docker_build "${DOCKERFILES_DIR}" Dockerfile_py3dev                ubuntu-18.04:base     ubuntu-18.04:py3dev
...
docker run --restart=unless-stopped --net=lab --ip=172.18.0.2 --hostname=polygon    --name=polygon      -d  polygon:v0.1
